...
<div
	class="text-[min(12vw,80px)] leading-[1] tracking-tighter text-center max-w-3xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-black to-gray-700 h-auto"
>
